            ...
            >
                {
                    testimonials?.map(testimonial => <SwiperSlide key={testimonial?._id}>
                        <div className='flex flex-col items-center md:w-8/12 mx-auto'>
                            <Rating
                                style={{ maxWidth: 300 }}
                                value={testimonial?.rating}
                                readOnly
                            />
                            <svg className='mt-5' xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
                            ...
                            <p className='mt-5 text-center text-[#151515]'>{testimonial?.details}</p>
                            <h3 className='text-2xl text-[#CD9003] mt-1 font-cinzel font-bold'>{testimonial?.name}</h3>
